...
class Succes2page extends StatefulWidget {
  const Succes2page({super.key});

  @override
  State<Succes2page> createState() => _Succes2pageState();
}

class _Succes2pageState extends State<Succes2page> {
  @override
  void initState() {
    super.initState();
