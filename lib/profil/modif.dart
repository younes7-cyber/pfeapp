                                          ...
                                          TextButton(
                                            onPressed: () async {
                                                  ...
                                                  return const AlertDialog(
                                                    content: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        SizedBox(height: 16),
                                                        Text(
                                                            "Suppression du channel en cours..."),
                                                      ],
                                                    ),
                                                  );
                                                },
                                              ...
                                              try {
                                                ...
                                                for (var doc
                                                    in channelsToDelete.docs) {
                                                  await doc.reference.delete();
                                                }

                                                final followsAsFollower =
                                                    await firestore
                                                        .collection('follow')
                                                        .where('idfollowers',
                                                            isEqualTo:
